...
potcar = Potcar(elements_list=['Ba','Ti','O'])

print potcar.get_minimal_form()

potcar_2 = Potcar(minimal_form=potcar.get_minimal_form())

print potcar_2.get_minimal_form()

print potcar_2.lines == potcar.lines
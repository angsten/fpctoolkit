...
class VaspPolarizationRunSet(object):
	...
	def create_new_vasp_run(self, path, structure):
		...
		input_set = VaspInputSet(structure, kpoints, incar, auto_change_lreal=('lreal' not in run_inputs), auto_change_npar=(('isym' in run_inputs) and (run_inputs['isym'] == -1) and ('npar' not in run_inputs)))
	...
	def get_change_in_polarization(self):
		...
		return total_polarization_vector #minimum_polarization_vector
